...
public class TelaLogin extends javax.swing.JFrame {
    ...
    controller.Jogador jogador = new Jogador();
    controller.Jogador[] vetorJogadores;
    ...
    public void carregarTabelaJogadores(){
        ...
        vetorJogadores = new Jogador[jogador.buscarJogadores().length];
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Real Life Game");

        jLabel2.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        jLabel2.setText("Selecione um Jogador e clique em Jogar");

        btnJogar.setBackground(new java.awt.Color(153, 153, 255));
        ...
        btnEditar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/edit32.png"))); // NOI18N
    ...
    private void btnJogarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJogarActionPerformed
        Main telaMain = new Main(jogador.buscarJogador(dtmJogadores.getValueAt(tblJogadores.getSelectedRow(), 0).toString()));
        this.dispose();
    ...
    public void telaEditor(){
        TelaEditor telaEditor = new TelaEditor();
        telaEditor.setLocationRelativeTo(null);
